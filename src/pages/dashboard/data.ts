    ...
    data: [
      {
        ...
        v: '847',
        delta: '▲ 3.1%',
        line: [2, 2, 2, 2, 3, 4, 6, 9, 14, 18, 22, 26, 28, 27, 26, 24, 22, 20, 18, 16, 12, 8, 5, 3],
        lineColor: tk.yellowBase,
        fmt: fmtN,
        dayVals: [
          8, 10, 12, 14, 20, 35, 55, 80, 140, 210, 320, 440, 520, 510, 490, 460, 420, 380, 330, 280,
          210, 140, 80, 40,
        ],
      },
      {
        ...
        v: '71',
        delta: '▲ 2.2%',
        line: [1, 1, 1, 1, 2, 3, 4, 6, 10, 14, 18, 22, 24, 23, 22, 20, 18, 16, 14, 12, 8, 5, 3, 2],
        lineColor: tk.green,
        fmt: fmtN,
        dayVals: [
          1, 1, 1, 1, 2, 3, 4, 6, 8, 11, 15, 19, 22, 21, 20, 18, 16, 14, 12, 10, 7, 4, 2, 1,
        ],
      },
      {
        label: 'Ingresos',
        ...
        delta: '▼ 8%',
        line: [
          2, 2, 2, 2, 3, 5, 7, 10, 16, 20, 26, 30, 32, 31, 28, 26, 24, 22, 20, 17, 13, 9, 5, 3,
        ],
        lineColor: tk.redBase,
        fmt: fmtEur,
        dayVals: [
          20, 22, 25, 28, 40, 65, 90, 130, 190, 270, 370, 460, 530, 520, 500, 470, 430, 390, 340,
          290, 220, 150, 90, 50,
        ],
      },
      {
        ...
        delta: '▼ 5%',
        line: [
          6, 6, 7, 7, 8, 10, 12, 16, 20, 22, 24, 26, 28, 27, 26, 25, 24, 23, 22, 20, 18, 15, 12, 9,
        ],
        lineColor: tk.blueBase,
        fmt: fmtT,
        dayVals: [
          '00:42',
          '00:44',
    ...
    data: [
      {
        ...
        v: '12.293',
        delta: '→ 0%',
        line: [18, 20, 19, 22, 21, 24, 22],
        lineColor: tk.yellowBase,
        fmt: fmtN,
        dayVals: [11240, 11580, 11920, 12010, 12100, 12180, 12293],
      },
      {
        label: 'Recargas',
        v: '1.293',
        delta: '▲ 2.2%',
        line: [14, 18, 22, 20, 26, 24, 28],
        lineColor: tk.green,
        fmt: fmtN,
        dayVals: [1100, 1150, 1180, 1210, 1240, 1270, 1293],
      },
      {
        label: 'Ingresos',
        v: '1.641',
        delta: '▼ 8%',
        line: [32, 30, 28, 26, 24, 22, 18],
        lineColor: tk.redBase,
        fmt: fmtEur,
        dayVals: [2100, 2050, 1980, 1900, 1850, 1720, 1641],
      },
      {
        label: 'Tiempo medio',
        v: '01:42',
        delta: '▼ 5%',
        line: [16, 18, 20, 22, 24, 22, 26],
        lineColor: tk.blueBase,
        fmt: fmtT,
        dayVals: ['01:20', '01:28', '01:35', '01:38', '01:40', '01:41', '01:42'],
      },
    ],
  },
  Mes: {
    ...
    data: [
      {
        ...
        lineColor: tk.yellowBase,
        fmt: fmtN,
        dayVals: [38200, 42500, 45800, 48720],
      },
      {
        label: 'Recargas',
        v: '5.840',
      ...
      },
      {
        ...
        lineColor: tk.redBase,
        fmt: fmtEur,
        dayVals: [18900, 21200, 23100, 24310],
      },
      {
        label: 'Tiempo medio',
        v: '01:38',
        ...
        lineColor: tk.blueBase,
        fmt: fmtT,
        dayVals: ['01:30', '01:35', '01:40', '01:38'],
      },
    ],
  },
  Año: {
    ...
    data: [
      {
        ...
        v: '312.480',
        delta: '▲ 18.3%',
        line: [8, 10, 12, 14, 16, 18, 20, 21, 22, 24, 25, 26],
        lineColor: tk.yellowBase,
        fmt: fmtN,
        dayVals: [
          198000, 210000, 222000, 235000, 248000, 262000, 272000, 280000, 288000, 297000, 305000,
          312480,
        ],
      },
      {
        ...
        v: '68.420',
        delta: '▲ 22.5%',
        line: [6, 8, 10, 13, 16, 18, 21, 23, 25, 27, 29, 30],
        lineColor: tk.green,
        fmt: fmtN,
        dayVals: [
          38000, 41000, 44500, 48000, 52000, 55500, 58500, 61000, 63500, 65500, 67000, 68420,
        ],
      },
      {
        label: 'Ingresos',
        v: '284.900',
        delta: '▲ 15.7%',
        line: [9, 11, 13, 15, 17, 19, 21, 23, 24, 25, 26, 28],
        lineColor: tk.redBase,
        fmt: fmtEur,
        dayVals: [
          185000, 197000, 210000, 222000, 234000, 245000, 255000, 263000, 269000, 274000, 280000,
          284900,
        ],
      },
      {
        ...
        v: '01:45',
        delta: '▼ 1.2%',
        line: [24, 22, 22, 20, 20, 18, 20, 20, 18, 18, 20, 20],
        lineColor: tk.blueBase,
        fmt: fmtT,
        dayVals: [
          '01:52',
...
export function getCustomPeriodData(from: string, to: string): PeriodData | null {
  ...
  if (diff < 7)
    return {
      labels: ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'].slice(0, Math.ceil(diff) + 1),
      data: STATS_BY_PERIOD['Semana'].data,
    };
  if (diff < 30)
    return {
      labels: ['S1', 'S2', 'S3', 'S4'].slice(0, Math.ceil(diff / 7) + 1),
      data: STATS_BY_PERIOD['Mes'].data,
    };
  if (diff < 365)
    return {
      labels: [
        ...
        'Nov',
        'Dic',
      ].slice(0, Math.ceil(diff / 30) + 1),
      data: STATS_BY_PERIOD['Año'].data,
    };
  const n = Math.min(Math.ceil(diff / 365) + 1, 6);
  return {
    labels: Array.from({ length: n }, (_, i) => `${2021 + i}`),
    data: STATS_BY_PERIOD['Año'].data,
  };
}
...
export const CONECTORES = [
  {
    label: 'Total',
    iconKey: 'total' as const,
    avail: '97%',
    avDelta: '+0.2%',
    avUp: true as boolean | null,
    occ: '137',
    ocDelta: '+0.2%',
    ocUp: true as boolean | null,
  },
  {
    label: 'Mennekes',
    iconKey: 'mennekes' as const,
    avail: '98%',
    avDelta: '+1.2%',
    avUp: true as boolean | null,
    occ: '64',
  ...
  {
    label: 'CCS',
    iconKey: 'ccs' as const,
    avail: '96%',
    avDelta: '-0.1%',
    avUp: false as boolean | null,
    occ: '25',
    ocDelta: '-0.1%',
    ocUp: false as boolean | null,
  },
  {
    label: 'CHAdeMo',
    iconKey: 'chademo' as const,
    avail: '0',
    avDelta: '→ 0%',
    avUp: null as boolean | null,
    occ: '0',
    ocDelta: '→ 0%',
    ocUp: null as boolean | null,
  },
  {
    label: 'Otros',
    iconKey: 'schuko' as const,
    avail: '0',
    avDelta: '→ 0%',
    avUp: null as boolean | null,
    occ: '0',
